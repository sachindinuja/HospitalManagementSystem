                        ...
                        <div className='container-table100'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        {/*<button className="btn btn-success" onClick={generatePDF}>PDF</button>*/}<Link to={`/GenerateAppointmentPDF`} className='btn btn-success btn-sm mr-10' onChange={generatePDF}>PDF</Link>
                                    </div>
                                </div >
                            </div >
                        </div >
